...
echo Run KETTLE_JOB_FILE : %KETTLE_HOME%\job\B002-S04-W.kjb
call %EXEC_KITCHEN% /file:"%KETTLE_HOME%\job\B002-S04-W.kjb" %CMD_LINE_ARGS% /level:%LOG_LEVEL% >> %LOG_FILE%
if not %ERRORLEVEL% == 0 goto :end

echo Run KETTLE_JOB_FILE : %KETTLE_HOME%\job\B002-S04-M.kjb
call %EXEC_KITCHEN% /file:"%KETTLE_HOME%\job\B002-S04-M.kjb" %CMD_LINE_ARGS% /level:%LOG_LEVEL% >> %LOG_FILE%
if not %ERRORLEVEL% == 0 goto :end
