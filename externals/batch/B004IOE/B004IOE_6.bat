...
echo Run KETTLE_JOB_FILE : %KETTLE_HOME%\job\B002-S08.kjb
call %EXEC_KITCHEN% /file:"%KETTLE_HOME%\job\B002-S08.kjb" %CMD_LINE_ARGS% /level:%LOG_LEVEL% >> %LOG_FILE%
if not %ERRORLEVEL% == 0 goto :end

echo Run KETTLE_JOB_FILE : %KETTLE_HOME%\job\B002-S09.kjb
call %EXEC_KITCHEN% /file:"%KETTLE_HOME%\job\B002-S09.kjb" %CMD_LINE_ARGS% /level:%LOG_LEVEL% >> %LOG_FILE%
if not %ERRORLEVEL% == 0 goto :end

echo Run KETTLE_JOB_FILE : %KETTLE_HOME%\job\B002-S10.kjb
call %EXEC_KITCHEN% /file:"%KETTLE_HOME%\job\B002-S10.kjb" %CMD_LINE_ARGS% /level:%LOG_LEVEL% >> %LOG_FILE%
if not %ERRORLEVEL% == 0 goto :end

echo Run KETTLE_JOB_FILE : %KETTLE_HOME%\job\B002-S11.kjb
call %EXEC_KITCHEN% /file:"%KETTLE_HOME%\job\B002-S11.kjb" %CMD_LINE_ARGS% /level:%LOG_LEVEL% >> %LOG_FILE%
if not %ERRORLEVEL% == 0 goto :end
