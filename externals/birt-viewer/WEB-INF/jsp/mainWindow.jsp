...
<link href="${CONTEXT_PATH}/css/mainWindow.css" rel="stylesheet" type="text/css" />
<script src="${CONTEXT_PATH}/jquery/jquery-1.6.2.js"></script>
<script src="${CONTEXT_PATH}/js/mainWindow.js"></script>
</head>
<body>
<div id="top_nav">
<form name="mainForm" action="${CONTEXT_PATH}/dashboard" method=get>
    <div id="logo" class="left"><img src="${CONTEXT_PATH}/images/ipf_logo${CSS_LOCALE}.png" alt="IPF(定量的プロジェクト管理ツール)" />
    <!-- /logo --></div>
    <div id="top_nav_right">
        
        <!-- プロジェクト一覧 -->
        <div id="project_list" class="left">
            <label><ipf:message key="top.navi.project"/>：
                <logic:notEmpty name="result" property="projectList">
                <html:select name="result" property="PROJECT_ID" styleId="project_name" >
                    <html:optionsCollection name="result" property="projectList" value="projectId" label="projectName" />
                </html:select>
                </logic:notEmpty>
            </label>
        <!-- project_list --></div>
...
<!-- インクルードファイル:${result.includeFilePath} -->
</body>
</html>