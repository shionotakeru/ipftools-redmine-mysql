CREATE OR REPLACE FUNCTION func_r_s05_paging(parm_project_id integer, parm_ticket_id integer, parm_date_from date, parm_date_to date, parm_parent_id integer, parm_limmit integer)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION func_r_s05_paging(integer, integer, date, date, integer, integer) OWNER TO ipf;
