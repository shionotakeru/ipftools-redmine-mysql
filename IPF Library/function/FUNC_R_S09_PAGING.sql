-- Function: func_r_s09_paging(integer, integer, integer)

-- DROP FUNCTION func_r_s09_paging(integer, integer, integer);

CREATE OR REPLACE FUNCTION func_r_s09_paging(project_id integer, ticket_id integer, inlimmit integer)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION func_r_s09_paging(integer, integer, integer) OWNER TO ipf;
