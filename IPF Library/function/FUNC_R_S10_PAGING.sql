-- Function: func_r_s10_paging(integer, integer, integer, integer)

-- DROP FUNCTION func_r_s10_paging(integer, integer, integer, integer);

CREATE OR REPLACE FUNCTION func_r_s10_paging(project_id integer, ticket_id integer, parent_id integer, inlimmit integer)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION func_r_s10_paging(integer, integer, integer, integer) OWNER TO ipf;
