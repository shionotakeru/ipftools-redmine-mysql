-- Function: func_r_s14_paging_dtl(integer, integer, integer)

-- DROP FUNCTION func_r_s14_paging_dtl(integer, integer, integer);

CREATE OR REPLACE FUNCTION func_r_s14_paging_dtl(param_project_id integer, param_period_zone integer, param_inlimmit integer)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION func_r_s14_paging_dtl(integer, integer, integer) OWNER TO ipf;
