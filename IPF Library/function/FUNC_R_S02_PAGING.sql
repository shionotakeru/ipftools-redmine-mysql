-- Function: func_r_s02_paging(date, date, text, integer, integer, integer, integer)

-- DROP FUNCTION func_r_s02_paging(date, date, text, integer, integer, integer, integer);

CREATE OR REPLACE FUNCTION func_r_s02_paging(param_from_date date, param_to_date date, param_ticket_id text, param_proj_id integer, param_productivity integer, param_scale integer, in_limmit integer)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION func_r_s02_paging(date, date, text, integer, integer, integer, integer) OWNER TO ipf;
