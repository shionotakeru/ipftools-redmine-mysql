-- Function: func_r_s01_paging(integer, integer, date, integer, integer)

-- DROP FUNCTION func_r_s01_paging(integer, integer, date, integer, integer);

CREATE OR REPLACE FUNCTION func_r_s01_paging(project_id integer, ticket_id integer, date_to date, parent_id integer, inlimmit integer)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION func_r_s01_paging(integer, integer, date, integer, integer) OWNER TO ipf;
